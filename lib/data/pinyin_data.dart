...
class PinyinData {
  static const initials = <PinyinItem>[
    ...
    PinyinItem(
        text: 'ch',
        audioBase: 'chi',
        tip: '和 zh 一样翘舌，但要明显送气，像吹纸；读作吃，不要读成知',
        example: '吃饭的 chi',
        section: PinyinSection.initials),
    PinyinItem(
        text: 'sh',
  ...
  static const finals = <PinyinItem>[
    ...
    PinyinItem(
        ...
        section: PinyinSection.finals,
        isExampleAudio: true),
    // 介音韵母（三拼音节常用）：小学基础 24 韵母之外，拼读 xia/hua/guo 等会用到
    PinyinItem(
        text: 'ia',
        audioBase: 'ya',
        tip: 'i 作介音，再接 a；单独读像 ya',
        example: '牙齿的 ya',
        section: PinyinSection.finals),
    PinyinItem(
        text: 'iao',
        audioBase: 'yao',
        tip: 'i 作介音，再接 ao；单独读像 yao',
        example: '药的 yao',
        section: PinyinSection.finals),
    PinyinItem(
        text: 'ian',
        audioBase: 'yan',
        tip: 'i 作介音，再接 an；单独读像 yan',
        example: '眼睛的 yan',
        section: PinyinSection.finals),
    PinyinItem(
        text: 'iang',
        audioBase: 'yang',
        tip: 'i 作介音，再接 ang；单独读像 yang',
        example: '太阳的 yang',
        section: PinyinSection.finals),
    PinyinItem(
        text: 'iong',
        audioBase: 'yong',
        tip: 'i 作介音，再接 ong；单独读像 yong',
        example: '用的 yong',
        section: PinyinSection.finals),
    PinyinItem(
        text: 'ua',
        audioBase: 'wa',
        tip: 'u 作介音，再接 a；单独读像 wa',
        example: '青蛙的 wa',
        section: PinyinSection.finals),
    PinyinItem(
        text: 'uo',
        audioBase: 'wo',
        tip: 'u 作介音，再接 o；单独读像 wo',
        example: '我的 wo',
        section: PinyinSection.finals),
    PinyinItem(
        text: 'uai',
        audioBase: 'wai',
        tip: 'u 作介音，再接 ai；单独读像 wai',
        example: '外面的 wai',
        section: PinyinSection.finals),
    PinyinItem(
        text: 'uan',
        audioBase: 'wan',
        tip: 'u 作介音，再接 an；单独读像 wan',
        example: '弯曲的 wan',
        section: PinyinSection.finals),
    PinyinItem(
        text: 'uang',
        audioBase: 'wang',
        tip: 'u 作介音，再接 ang；单独读像 wang',
        example: '王子的 wang',
        section: PinyinSection.finals),
    PinyinItem(
        text: 'üan',
        audioBase: 'yuan',
        tip: 'ü 作介音，再接 an；单独读像 yuan',
        example: '圆圆的 yuan',
        section: PinyinSection.finals),
  ];
